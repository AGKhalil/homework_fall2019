...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        return [self.obs[i] for i in indices], [self.acs[i] for i in indices], [self.rews[i] for i in indices], [self.next_obs[i] for i in indices], [self.terminals[i] for i in indices]
